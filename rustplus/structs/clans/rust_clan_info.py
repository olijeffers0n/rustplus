...
class RustClanRole:
    ...
    def __str__(self):
        return (
            "RustClanRole[role_id={}, rank={}, name={}, can_set_motd={}, can_set_logo={}, can_invite={}, "
            "can_kick={}, can_promote={}, can_demote={}, can_set_player_notes={}, can_access_logs={}]"
        ).format(
            self._role_id,
            self._rank,
            self._name,
            ...
            self._can_promote,
            self._can_demote,
            self._can_set_player_notes,
            self._can_access_logs,
        )
...
class RustClanMember:
    ...
    def __str__(self):
        return "RustClanMember[steam_id={}, role_id={}, joined_time={}, last_seen={}, notes={}, online={}]".format(
            self._steam_id,
            self._role_id,
            self._joined_time,
            self._last_seen,
...
class RustClanInvite:
    ...
    def __str__(self):
        return "RustClanInvite[steam_id={}, recruiter={}, invited_time={}]".format(
            self._steam_id, self._recruiter, self._invited_time
        )
...
class RustClanInfo:
    def __init__(self, clan_info: ClanInfo) -> None:
        ...
        self._clan_name: str = clan_info.name
    ...
    def __str__(self):
        return (
            "RustClanInfo[clan_id={}, clan_name={}, clan_time_created={}, creator={}, motd={}, motd_time_set={}, "
            "motd_author={}, logo={}, colour={}, roles={}, members={}, invites={}, max_members={}]"
        ).format(
            self._clan_id,
            self._clan_name,
            self._clan_time_created,
            self._creator,
            self._motd,
            self._motd_time_set,
            self._motd_author,
